...
class EncounterServiceSpec extends WordSpec with MockFactory {
  ...
  "The Encounter Service" should {
    "update the ticket step when creating an encounter associated with a ticket" in {
      new Fixture {
